...
mv $ORDERER_GENERAL_LOCALMSPDIR/cacerts/* $ORDERER_GENERAL_LOCALMSPDIR/cacerts/ca.orderer.example.com-cert.pem
...
mkdir -p /data/orgs/orderer/orderer
cp -r $ORDERER_GENERAL_LOCALMSPDIR /data/orgs/orderer/orderer
